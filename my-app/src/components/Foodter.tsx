...
const Foodter = (props: Props) => {
  ...
  <div className="flex flex-wrap">
    ...
    <div className="w-full mt-6 lg:mt-0 md:w-1/2 lg:w-1/5">
      ...
      <ul>
        <li> <a  className="block text-gray-600 py-2">Team</a> </li>
        <li> <a  className="block text-gray-600 py-2">About us</a> </li>
        <li> <a  className="block text-gray-600 py-2">Press</a> </li>
      </ul>
    </div>
    <div className="w-full mt-6 lg:mt-0 md:w-1/2 lg:w-1/5">
      <h6 className="font-semibold text-gray-700 mb-4">Content</h6>
      <ul>
        <li> <a  className="block text-gray-600 py-2">Blog</a> </li>
        <li> <a  className="block text-gray-600 py-2">Privacy Policy</a> </li>
        <li> <a  className="block text-gray-600 py-2">Terms &amp; Conditions</a> </li>
        <li> <a  className="block text-gray-600 py-2">Documentation</a> </li>
      </ul>
    </div>
    <div className="w-full mt-6 lg:mt-0 md:w-1/2 lg:w-1/5">
      <h6 className="font-semibold text-gray-700 mb-4">Company</h6>
